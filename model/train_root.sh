...
export EXPERIMENT_NAME="TRAIN_SCARA_ROOT"
...
python -m model.train \
    --data_path "data/scAraFM_Root/pretrain/subset" \
    --compile \
    --depth $DEPTH \
    --gene_num $GENE_NUM \
    --heads $HEADS \
    ...
    --gene_csv "data/scAraFM_Root/pretrain/subset/consensus_hvg.csv" \
    "$@"
